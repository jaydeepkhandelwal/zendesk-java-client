...
public class Zendesk implements Closeable {
  ...
  public void deleteAutomation(long automationId) {
    ...
    public CommentWithUsers getTicketCommentsWithUsers(long id) {
        return complete(submit(req("GET", tmpl("/tickets/{id}/comments.json?include=users")
         .set("id", id)), handle(CommentWithUsers.class, "")));
